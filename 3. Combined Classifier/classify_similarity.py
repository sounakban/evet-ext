...
def get_testDocs(file_path="target_doc"):
	docs = []
...
import os
for filename in os.listdir("./Data_Docs"):
	test_docs = get_testDocs(os.path.join("./Data_Docs", filename))
	run_similarity(terms, labels, test_docs, os.path.join("./Data_Docs", filename))
